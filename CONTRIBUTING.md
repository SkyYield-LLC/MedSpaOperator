# Contributing to Stacks · MedSpaOperator
...
```bash
git clone https://github.com/SkyYield-LLC/MedSpaOperator.git
cd medspaoperator
npm install
...
- `main` → production (auto-deploys to https://medspaoperator.vercel.app)
...
Push to `main` → Vercel auto-deploys to https://medspaoperator.vercel.app.

## Where to ask for help

- **Linear:** [Stacks · MedSpaOperator](https://linear.app/skyyield/project/stacks-medspaoperator-770ae115a67a) — file an issue or comment on existing
